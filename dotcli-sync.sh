...
mkdir -p files/live/en-us/demo.dotcms.com/application/shopify/vtl
mkdir -p files/live/en-us/demo.dotcms.com/application/shopify/gql

# hardlinks so you can edit them
ln ../src/main/resources/vtl/*.vtl files/live/en-us/demo.dotcms.com/application/shopify/vtl/
ln ../src/main/resources/gql/*.gql files/live/en-us/demo.dotcms.com/application/shopify/gql/
